...
const About = () => (
  <Container>
    <Stack>
      ...
      <p>
        It just so happens that I enjoy journalling, and see writing as a means
        to learning more while connecting with people and organizations.
      </p>
      <p>
        This place is for me to show off my experiments/projects in code, talk
        about the new things I learn or just discuss challenges and how you can
        also overcome them. It's also where I get to share thoughts on a wide
      ...
      <ul>
        ...
        <li>
          Finance and Capital Markets (I've traded the stock, forex and futures
          markets on my own, since 2008).
        </li>
      </ul>
      <p>
