...
summary: "This is the first post on here, the title is fitting."
---
...
So I signed up with [Bloc](http://bloc.io) in late 2016, to take on their Software Developer Track _(EDIT: they've since changed how they structured their programs. A lot of the CS extras that I'm being taught are now add-on modules for their Web Development Track)_. I figured it’s perfect because not only will I learn some practical skills, I’ll be learning the good stuff from a computer science degree. Things like algorithms, data structures, and more.
